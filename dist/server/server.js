...
const getRoomRedoStack = (room) => {
    if (!roomRedoStacks.has(room))
        roomRedoStacks.set(room, []);
...
io.on("connection", (socket) => {
    ...
    const emitUserCount = (room) => {
        var _a;
        const count = ((_a = io.sockets.adapter.rooms.get(room)) === null || _a === void 0 ? void 0 : _a.size) || 0;
